    ...
    <div class="main_container">
        ...
        <div class="left_col scroll-view">
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="assets/images/deni.jpg" alt="..." class="img-circle profile_img">
            </div>
            <div class="profile_info">
              <span>Welcome,</span>
              <h2>Wahidin Deni Kurniawan</h2>
            </div>
          </div>
          <!-- /menu profile quick info -->
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown open">
                <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                  <img src="assets/images/deni.jpg" alt="">Wahidin Deni Kurniawan
                </a>
      ...
      <footer>
        <div class="pull-right">
          Copyright @ 2021 Aplikasi Akademik : Wahidin Deni Kurniawan
        </div>
        <div class="clearfix"></div>
      </footer>
      <!-- /footer content -->
