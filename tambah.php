...
if (isset($_POST['submit'])) {
	...
	if (mysqli_num_rows($cek) == 0) {
		$sql = mysqli_query($koneksi, "INSERT INTO mahasiswa(Nim, Nama_Mhs, Telepon, Jenis_Kelamin, Program_Studi) VALUES('$Nim', '$Nama_Mhs', '$Telepon', '$Jenis_Kelamin', '$Program_Studi')") or die(mysqli_error($koneksi));
