...
<div class="container" style="margin-top:20px">
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($koneksi, "UPDATE mahasiswa SET Nama_Mhs='$Nama_Mhs', Telepon='$Telepon', Jenis_Kelamin='$Jenis_Kelamin', Program_Studi='$Program_Studi' WHERE Nim='$Nim'") or die(mysqli_error($koneksi));
